...
public class StrategyConfig {
    ...
    public StrategyConfig() {
        ...
        this.maxLossPrecen = ValuesUtil.getDefaultLossPrecent();
    ...
    public StrategyConfig(Double customSlPercent, Double customMaxLossInPosition, int[] customLeverageTrails,
        ...
        this.maxLossPrecen = customMaxLossInPosition != null ? customMaxLossInPosition : ValuesUtil.getDefaultLossPrecent();
